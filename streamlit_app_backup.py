...
if not st.session_state.authenticated or sessao_expirada():
    ...
    def initialize_backend():
        ...
        try:
            ...
            possible_paths = [
                os.path.join(os.getcwd(), "data", "parquet", "admmat.parquet"),
                "/mount/src/agents_solution_business/data/parquet/admmat.parquet",  # Streamlit Cloud
                "data/parquet/admmat.parquet",  # Relativo
                "./data/parquet/admmat.parquet"  # Relativo explícito
            ]
